                    ...
                    <Navbar.Collapse id="responsive-navbar-nav bg-light text-white">
                        ...
                        <Nav className="bg-light">
                            {/* <Nav.Link className="nav-item"> */}
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.inspireui.winstore.vendor" target="blank"><img src="imgs/2c7f33d1-b9de-42a4-8720-fba8621835be.png" alt="2c7f33d1-b9de-42a4-8720-fba8621835be Winstore Products" className="img-fluid blinking" style={{height:"50px"}} /></a>
                            {/* </Nav.Link> */}
