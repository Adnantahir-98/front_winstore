                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-3">
                                    ...
                                    <ul className="navbar-nav">
                                        <li className="nav-item"><Link to="#" className="text-dark">Electronics</Link></li>
                                        <li className="nav-item"><Link to="#" className="text-dark">Sport and Outdoors</Link></li>
                                        <li className="nav-item"><Link to="#" className="text-dark">Men Store</Link></li>
                                        <li className="nav-item"><Link to="#" className="text-dark">Women Store</Link></li>
                                        ...
                                        <li className="nav-item"><Link to="#" className="text-dark">Grocery</Link></li>
